            ...
            <div class="login-left">
                <div class="login-left-content">
                    <div class="image-composition" style="position: relative; width: 100%; max-width: 500px; aspect-ratio: 1; margin: 0 auto;">
                        ...
                        <img src="${pageContext.request.contextPath}/public/images/admin.webp" alt="Admin" style="position: absolute; top: 0; left: 0; width: 88%; height: 88%; object-fit: cover; z-index: 2; border-radius: 20px; box-shadow: 12px 12px 30px rgba(0,0,0,0.4);" loading="lazy" />
                    </div>
                </div>
            </div>
